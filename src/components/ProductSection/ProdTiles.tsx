...
const ProdTiles = () => {
  ...
  return (
    <>
      <main className="grid grid-cols-4 max-xl:grid-cols-2 items-center gap-4 m-8">
        {items.map((item) => (
          <div
          ...
          >
            ...
            <h1 className="text-[#111010] text-2xl font-bold mt-4 max-xl:p-1">
              {item.name}
            </h1>
            <p className="text-[#CACACA] text-sm my-2 max-xl:p-2">
              {item.oldPrice}{" "}
