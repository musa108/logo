...
const Vision = () => {
  ...
  return (
    <>
      {items.map((item) => (
        <div className=" relative my-14 lg:mx-20 max-lg:my-12 max-lg:flex max-lg:flex-col-reverse">
          <img
            src={item.image}
            alt={item.image}
            className="max-lg:w-[435px] max-lg:h-[672px]"
          />
          <div className="bg-[#F7F7F7] lg:absolute lg:top-16 lg:left-[-4rem] lg:py-16 lg:pl-4 lg:w-max p-4 w-[345px] m-auto">
