  ...
  return (
    <>
      <main className="mt-4 relative">
        <img src={heroImage} alt="" className="max-lg:h-[434px] overflow-hidden" />
        <section className="bg-[#000000] max-lg:bg-[#666A6F] bg-opacity-30 font-ProximaNova absolute top-8 right-8 p-8 max-lg:p-4 max-lg:top-96 max-lg:left-5">
          ...
          <button className="bg-[#FFF] px-12 py-2 max-lg:px-6 max-lg:py-1 font-bold uppercase hover:bg-[#000000] hover:text-[#FFF]">
